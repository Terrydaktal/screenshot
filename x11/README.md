...
This is the retired X11 implementation of `screenshot`. It remains buildable for
X11 sessions, but new development targets KDE Plasma 6 Wayland in `../wayland`.
